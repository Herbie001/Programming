...
class Graph {
    private:
    /**
     * adjacency list representation: {node, {node, edgeWeight}}
     */
    unordered_map<string, unordered_map<string, double>> adj;
    
    /**
     * Vector consisting strictly of nodes. 
     */
    ...
    public:
        ...
        void insertNodesToVector(string node1, string node2, vector<string> & nodesVector);
        ...
        void dfs(const string& node, double threshold, unordered_map<string, bool>& visited, vector<string>& component);

        // Needed for smallest_connecting_threshold - CSE101
        unordered_map<string, double> dijkstra(string const & start_label, unordered_map<string, double> & max_edge_weights);
